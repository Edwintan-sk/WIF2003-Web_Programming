  ...
  return (
        <main>
            <header className="d-flex justify-content-between align-items-start mb-5">
                <div>
                  <p className="text-secondary fw-bold text-uppercase text-micro mb-1">Workspace / Submit Progress</p>
              ...
              <Col lg={8}>
                ...
                <div className="custom-card p-4 mb-4">
                  <div className="d-flex align-items-center gap-2 mb-3">
                    <span className="badge rounded kpi-tag font-monospace" style={{ backgroundColor: '#e2efe9', color: '#183628' }}>
                      Community
                    </span>
                  ...
                  <div className="d-flex align-items-center gap-3">
                    <span className="fw-semibold text-uppercase text-muted text-overline">
                      Current
                    </span>
                    <div className="progress-track-md flex-grow-1 overflow-hidden rounded-pill">
                ...
                <div className="custom-card p-4 p-md-5">
                  ...
                  <div className="mb-5">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <div className="serif-font fw-bold fs-5 text-primary-dark">
                        75% → {progressValue}%
                      </div>
                    </div>
                    ...
                    <div className="position-relative mb-2">
                      ...
                      <input type="range" className="custom-range w-100" min="0" max="100" step="25" 
                    ...
                    <div className="d-flex justify-content-between text-muted text-mini fw-medium">
                      <span>0%</span>
                      <span>25%</span>
                      <span>50%</span>
                      <span>75%</span>
                  ...
                  <div className="mb-5">
                    ...
                    <div className="dashed-dropzone" onClick={handleDropzoneClick}>
                      {selectedFile ? (
                        <div>
                          <div className="fw-bold mb-1 fs-6 text-primary-dark d-flex justify-content-center align-items-center gap-2">
                            📄 {selectedFile.name}
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted">PDF, JPG, PNG, MP4 · up to 25 MB each</div>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="d-flex justify-content-between align-items-center pt-2">
                    <button className="btn btn-outline-custom shadow-sm">
                      Save draft
                    </button>
                    <button className="btn btn-primary-dark shadow-sm d-flex align-items-center gap-2">
              ...
              <Col lg={4}>
                ...
                <div className="custom-card p-4 mb-4">
                  ...
                  <div className="history-item">
                    ...
                    <div>
                      <div className="fw-bold mb-1 text-sm text-dark">Oct 15</div>
                      <div className="text-muted text-mini">Approved — Event 2 complete</div>
                    </div>
                  </div>
                  ...
                  <div className="history-item">
                    ...
                    <div>
                      <div className="fw-bold mb-1 text-sm text-dark">Sep 02</div>
                      <div className="text-muted text-mini">Approved — Event 1 complete</div>
                    </div>
                  </div>
                  ...
                  <div className="history-item">
                    ...
                    <div>
                      <div className="fw-bold mb-1 text-sm text-dark">Aug 10</div>
                      <div className="text-muted text-mini">KPI assigned by Lee Chen</div>
                    </div>
                  </div>
                </div>

                {/* Note Widget */}
                <div className="custom-card info-card p-4">
                  <h5 className="serif-font fw-bold mb-3 fs-5">A note on evidence</h5>
                  <p className="mb-0 text-sm text-note">
